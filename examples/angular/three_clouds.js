...
function SampleController($scope) {
  $scope.orthography1 = localStorage.getItem("cloud1") ? JSON.parse(localStorage.getItem("cloud1")) : {
    id: "cloud1",
  ...
  $scope.orthography2 = localStorage.getItem("cloud2") ? JSON.parse(localStorage.getItem("cloud2")) : {
    id: "cloud2",
  ...
  $scope.orthography3 = localStorage.getItem("cloud3") ? JSON.parse(localStorage.getItem("cloud3")) : {
    id: "cloud3",
  ...
  return {
    link: function(scope, element, attr) {
      ...
      cloudHolder.cloud = new WordCloud({
        element: element[0],
        onWordClick: scope.onWordClick,
        onWordMouseover: function(word) {
      ...
      scope.$watch(attr.cloudContent, function(newValue, oldValue) {
        ...
        cloudHolder.cloud.id = newValue.id;
        cloudHolder.cloud.orthography = newValue.orthography;
        cloudHolder.cloud.width = newValue.width;
        cloudHolder.cloud.height = newValue.height;
        if (newValue.wordFrequencies && !cloudHolder.cloud.wordFrequencies) {
          cloudHolder.cloud.wordFrequencies = newValue.wordFrequencies;
        }
